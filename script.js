...
const masterArray = [
  ...
  },
  {
    tagName: "Asparagus",
    textQuestion:
      "You walk on the floor and you find Asparagus under your feet.",
  ...
  },
  {
    tagName: "Tissue",
    textQuestion:
      "As you reach to turn on the light you notice Tissue paper under it.",
  ...
  },
  {
    tagName: "Grapes",
    textQuestion:
      "You went to the bathroom and you found Grapes in your toilet.",
  ...
  },
  {
    tagName: "Beer",
    textQuestion:
      "You went to bathroom and notice your bathtub is full of Beer.",
  ...
  },
  {
    tagName: "Pepper",
    textQuestion:
      "You went to grab your jeans but it's pockets were full of black Pepper.",
  ...
  },
  {
    tagName: "Bread",
    textQuestion:
      "As you were walking on the floor, instead of tiles, you found Bread everywhere.",
  ...
  },
  {
    tagName: "Cheese",
    textQuestion:
      "You come down the stairs but there's Cheese everywhere on your stairs.",
  ...
  },
  {
    tagName: "Cherries",
    textQuestion:
      "You wash your face but notice that the sink is full of Cherries.",
  ...
  },
  {
    tagName: "Coffee",
    textQuestion:
      "You take a glass for pouring water but instead its full of Coffee Beans.",
  ...
  },
  {
    tagName: "Cookies",
    textQuestion:
      "You look outside the window and notice squirrels eating all your Cookies.",
  ...
  },
  {
    tagName: "Donuts",
    textQuestion:
      "While lying down on your bed, you notice there are Donuts everywhere on the ceiling.",
  ...
  },
  {
    tagName: "Egg",
    textQuestion:
      "As you get into your car, you see that the windshield is full of Egg yolk.",
  ...
  },
  {
    tagName: "Ginger",
    textQuestion:
      "You set out to do laundry but instead you find Ginger in your Washing Machine.",
  ...
  },
  {
    tagName: "Ice Cream",
    textQuestion:
      "You notice that Ice Cream is dripping from your vanity mirror.",
  ...
  },
  {
    tagName: "Ketchup",
    textQuestion:
      "As you go to your family room, you find Ketchup on the walls.",
  ...
  },
  {
    tagName: "Pizza",
    textQuestion:
      "In your living room, you notice that wall clock has been replaced by a Pizza.",
  ...
  },
  {
    tagName: "Popcorn",
    textQuestion:
      "As you open your fridge, you notice that it's full of Popcorn and they're spilling everywhere.",
  ...
  },
  {
    tagName: "Red Wine",
    textQuestion:
      "You open your tap to get some water, but you're greeted with Red Wine instead.",
  ...
  },
  {
    tagName: "Spaghetti",
    textQuestion:
      "You grab your comb, but instead of bristles its full of Spaghetti.",
  ...
  },
  {
    tagName: "Spinach",
    textQuestion:
      "In your backyard lawn, instead of grass you see Spinach everywhere.",
...
$(document).ready(function() {
    ...
    $(".listItem")
      ...
      .on("click", function() {
        if (userPickArray.length < questionsArray.length) {
          ...
          ////used some method which gives a boolean value back, true or false
  ...
  $(".proceedToResults").on("click", function() {
    $(".proceedToResults").hide();
    $(".results").text(
      `You answered ${correctArray.length} out of ${questionsArray.length} correctly.`
    );
    $(".results").show();
    $("ul li").each(function() {
